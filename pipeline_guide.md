...
## Canonical pipeline
- `build_faers_cohort.py` is the main pipeline script.
...
## Legacy pipeline
- `build_faers_cohort_legacy.py` is kept only as an older reference implementation.

## Recommended command
```powershell
& "C:/Users/dongz/OneDrive/Desktop/Project Code/Diphenhydramine_Misuse/.venv/Scripts/python.exe" "build_faers_cohort.py" --base-dir "." --extracted-root "data/faers_extracted" --rxnorm-rrf "RxNorm/RxNorm_full_prescribe_03022026/rrf/RXNCONSO.RRF" --acb-csv "data/lookups/acb_lookup.csv" --chunksize 100000 --start-phase 6
```

## Output path summary
- `03_filtered/teen_demo_records.csv`: teen DEMO cohort
...
- `05_final/cohort_analysis.csv`: final analysis-ready cohort table
