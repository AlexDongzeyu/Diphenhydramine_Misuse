...
def main() -> None:
    ...
    demo_teens = filtered / "teen_demo_records.csv"
    teen_ids_txt = filtered / "dph_confirmed_ids.txt"
    ...
    drug_teens = filtered / "teen_drug_records.csv"
    reac_teens = filtered / "teen_reaction_records.csv"
    outc_teens = filtered / "teen_outcome_records.csv"
    ...
    drug_dph = filtered / "dph_drug_records.csv"
    reac_dph = filtered / "dph_reaction_records.csv"
    outc_dph = filtered / "dph_outcome_records.csv"
    ...
    drug_norm = processed / "dph_drug_normalized.csv"
    normalize_drug_table(drug_dph, drug_norm, rx_map, args.chunksize)

    acb_case_csv = processed / "acb_by_case.csv"
    ...
    final_csv = paths["final"] / "cohort_analysis.csv"
